...
-   Do students' non-friendship agree with teachers' observations of
    non-friendship?
...
`student-reported-friends.xlsx` file, add row and column names, and
...
-   A **class** is just a blueprint or a sketch of these objects. It
...
2.  Who reported more friendships, teachers or students? How do you
    ...
    -   Students reported more friendships. Students reported 203 edges
        and teachers - 69 edges.
...
analysis with wider audience. Krumm et al. (2018) outlined the following
...
The question: Are students and teachers different in their perceptions
about achievements? Students and teachers have different perceptions
about achievements. For example, audience can compare the outliers from
teachers' perceptions. For example, they think student 20 has low
achievements and no ties while student 20 has dense ties. I may add
ethnicity or culture attribute to examine whom teachers perceive as
outliers.
